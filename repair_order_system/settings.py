"""
Django settings for repair_order_system project.
...
SECRET_KEY = 'django-insecure-&$__mf!csw^@ifqdoy0(19ivfc%wds=yomvet53&-r@#14-9+l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['35.226.213.165']
...
MIDDLEWARE = [
    'repair_order_system.middleware.print_request_middleware.PrintRequestMiddleware',
...
WSGI_APPLICATION = 'repair_order_system.wsgi.application'
